This is a deque class which I made as a project to represent a deque object which uses a doubly linked list to  create all associated operations for this data type.  
